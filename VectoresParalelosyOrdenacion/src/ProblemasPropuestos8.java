...
public class ProblemasPropuestos8 {
	...
	static void ascendente(){
		...
		}for(int i=numerospequeños.length;i<numeros.length;i++){
			numerospequeños[i-numerospequeños.length]=numeros[i];
		}
			}
	...
	static void descendente(){
		...
		for(int i=numerospequeños.length;i<(numeros.length);i++){
			numerosgrandes[i-numerospequeños.length]=numeros[i];
		}
			}
	...
	System.out.println();
	System.out.println("Los numeros pequeños son:");
	for(int i=0;i<numerospequeños.length;i++)System.out.print(numerospequeños[i] + " ");
