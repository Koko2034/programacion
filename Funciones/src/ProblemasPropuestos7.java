...
/*
 * Ejercicios 2-9
Crea una biblioteca de funciones para arrays (de una dimensión) de
...
parámetro.
4. mediaArrayInt: Devuelve la media del array que se pasa como
parámetro.
...
un array.
9. rotaIzquierdaArrayInt: Rota n posiciones a la izquierda los números
de un array.
 */
	}
